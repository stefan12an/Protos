    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sendText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(AccountSetup.this, "Added sucsessfully", Toast.LENGTH_SHORT);
            }
        });
        ...
        ref.putFile(imguri)
                .addOnSuccessListener((new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(AccountSetup.this, "Image Uploaded succesfully", Toast.LENGTH_SHORT);
                    }
                }))
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(AccountSetup.this, "Image Upload error", Toast.LENGTH_SHORT);
                    }
                });
    }
